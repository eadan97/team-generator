...
player_management_v2 = st.Page("pages/1_player_management_v2.py", title="Player management (beta)", icon="👤")
...
# Set up navigation
pg = st.navigation([main_page, page_1, player_management_v2, page_2, page_3, leaderboard])
